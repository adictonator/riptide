					...
					Dom.getSiblings(item, '[aria-expanded="true"]').forEach(
						function (siblingItem) {
							var siblingAnswerWrapper =
								siblingItem.querySelector('.Faq__AnswerWrapper')
		...
		_createClass(HeaderSection, [
			...
			},
			{
				...
				value: function _setupLocalizationPopovers() {
					// riptide is an extremely complex theme, especially in the header due to the various layouts that power different
